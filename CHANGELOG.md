...
- **278 tools** across **28 modules** covering nearly the entire Premiere Pro ExtendScript and QE DOM API surface
...
- **transitions** (6) — Lookup and add transitions by name/matchName (QE DOM)
...
- **export** (16) — Sequence export, diagnostics, frame capture (base64), FCP XML, AAF, OMF, encoding
